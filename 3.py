...
def clear_text(path: str, i:str) -> list:
    ...
    raw_title = html.xpath(r'/html/body/div[3]/div/div/div/div/div[2]/div[3]/div/div[2]/div/ul/li[1]/span[1]/a')
...
path_1 = "D:\githubDownLoad\HTML\国家乡村振兴局 帮扶政策"
path_2 = "D:\githubDownLoad\HTML\国家乡村振兴局 地方政策"
path_3 = "D:\githubDownLoad\HTML\国家乡村振兴局 振兴要闻"
